...
ActiveRecord::Schema.define(version: 20180329064929) do
  ...
  create_table 'admin_users', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index ['email'],
            name: 'index_admin_users_on_email', unique: true
  ...
  create_table 'cupcakes', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index ['category_id'],
            name: 'index_cupcakes_on_category_id'
  end
